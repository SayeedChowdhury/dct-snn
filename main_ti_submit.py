...
import datetime
#import pdb
from spike_model_tinyimagenet import *
import sys
import os
import shutil
import math
...
def test(epoch, loader):
    ...
    with torch.no_grad():
        ...
        filename = 'snn_'+architecture.lower()+'_'+dataset.lower()+'_'+str(timesteps)+'_lr'+str(learning_rate)+'_'+str(batch_size)+'_4*4_99.9_latest'+'.pth'
...
architecture        = 'VGG13'
print_to_file       = True
log_file            = 'snn_'+architecture.lower()+'_'+str(update_interval)+'_'+str(batch_size)+'_usual_4*4_wd5e-4_99.9_latest'+'.log'
pretrained          = True


pretrained_state    = '/home/vgg9_snn_surrgrad_backprop/CHECKPOINTS/'+'vgg13_tinyimgnet_ann_lr.01_.1by100_bs64_pixel_seed0org_4096_wd1e-4_acc56.91'+'/ckpt.pth'

#pretrained_state    =       './best_snn_vgg13_tinyimagenet_125_lr0.0001_32_4*4_99.9_wd5e-4_n2.pth'

find_thesholds      = True

freeze_conv         = False
resume              = False
#resume              = './snn_vgg5_cifar10_128_lr0.0002_32_samdct2_1e-4_ajairabig.pth'
learning_rate       = 1e-4
lr_adjust_interval  = 6
...
#VGG13 tinyimgnet 4*4 from pix 99.9 thresholds 6.5-93.5
ann_thresholds = [2.8, 3.76, 1.2, 2.38, .89, 1.81, 0.59, 1.01, 0.44, .83, 0.2, .65]
